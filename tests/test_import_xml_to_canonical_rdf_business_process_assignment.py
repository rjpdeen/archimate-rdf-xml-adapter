...
def test_import_from_file_inserts_business_process_and_assignment_into_named_graph() -> None:
    ...
    try:
        ...
        service.import_from_file("tests/fixtures/xml/business_process_assignment.xml")
